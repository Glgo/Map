...
import com.example.guo.map.BusLineOverlay;
...
/**
 * 展示如何进行公交线路详情检索，并使用RouteOverlay在地图上绘制 同时展示如何浏览路线节点并弹出泡泡
 */
public class BusLineActivity extends FragmentActivity implements
    ...
    public void onGetBusLineResult(BusLineResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BusLineActivity.this, "抱歉，未找到结果",
        ...
        Toast.makeText(BusLineActivity.this, result.getBusLineName(),
